                ...
                if let snapshotsDocuments = querySnapshot?.documents {
                    for doc in snapshotsDocuments {
                        ...
                        if let name = data["name"] as? String,
                            ...
                            let item = Item(name: name, quantity: quantity, images: [], minLevel: minLevel, price: price, notes: notes, tags: tags, sortlyId: sortlyId, createdAt: createdAt.dateValue(), updatedAt: updatedAt.dateValue())
